...
<p>
  In college, I consistently earned top grades in programming modules and <span className="green-text">taught</span> the fundamentals of web development and Java to children. I developed a <span className="green-text">language-learning app</span> that became the focus of my Master's dissertation and was pilot tested in Irish primary schools with great results. I now lead its ongoing development part-time, managing a small team of engineers.
</p>
<p>
